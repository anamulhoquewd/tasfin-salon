...
interface OpeningHour { day: string; time: string }
interface HeroContent { salonName: string; eyebrow: string; slogan: string; primaryCta: string; secondaryCta: string }
interface IntroContent { title: string; body: string }
...
const SettingsSchema = new Schema<ISettings>(
  {
    ...
    whatsapp: { type: String, default: '+8801975024262' },
    phone: { type: String, default: '+880 1975 024 262' },
    email: { type: String, default: 'hello@tasfin.com' },
    address: { type: String, default: 'House 41, Road 11, Gulshan 2, Dhaka 1212' },
